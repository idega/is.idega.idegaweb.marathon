...
public class CharityServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.marathon.webservice.server.CharityServiceService {
    ...
    public is.idega.idegaweb.marathon.webservice.server.CharityService_PortType getCharityService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.marathon.webservice.server.CharityServiceSoapBindingStub _stub = new is.idega.idegaweb.marathon.webservice.server.CharityServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.marathon.webservice.server.CharityService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.marathon.webservice.server.CharityServiceSoapBindingStub _stub = new is.idega.idegaweb.marathon.webservice.server.CharityServiceSoapBindingStub(new java.net.URL(CharityService_address), this);
                _stub.setPortName(getCharityServiceWSDDServiceName());
                return _stub;
            }
        }
