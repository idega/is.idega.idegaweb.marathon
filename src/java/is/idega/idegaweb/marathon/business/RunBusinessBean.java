...
public class RunBusinessBean extends IBOServiceBean implements RunBusiness{
  ...
  public int saveUser(String name,String ssn,String gender,String address,String postal,String city,String country,String tel,String mobile,String email) {
    ...
    try {
      ...
      //TODO: look up the users phonenumbers and email - only create new if doesn't exist - else update or do nothing if same data
  ...
  public void saveRun(int userID,String run,String distance,String year,String nationality,String tshirt,String chipNumber,String groupName,String bestTime,String goalTime) {
    ...
    try {
      ...
      if(distance!=null && !distance.equals("")) {
        ...
        Collection groups = getGroupBiz(IWContext.getInstance()).getChildGroupsRecursive(disGroup,groupType,true);
  ...
  /**
   * 
   * @param pin - a social security number - format ddmmyyxxxx or ddmmyyyy
  ...
  private String getGroupName(int age, Group group, int genderID) {
    ...
    if(runName.equals("Rvk Marathon") || runName.equals("Roller Skate")) {
      if(age <= 14) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_14;
        else nameOfGroup = IWMarathonConstants.MALE_14;
      }
      else if(age > 14 && age <= 17) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_15_17;
        else nameOfGroup = IWMarathonConstants.MALE_15_17;
      }
      else if(age > 17 && age <= 39) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_18_39;
        else nameOfGroup = IWMarathonConstants.MALE_18_39;
      }
      else if(age > 39 && age <= 49) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_40_49;
        else nameOfGroup = IWMarathonConstants.MALE_40_49;
      }
      else if(age > 49 && age <= 59) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_50_59;
        else nameOfGroup = IWMarathonConstants.MALE_50_59;
      }
      else if(age > 59) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_60;
        else nameOfGroup = IWMarathonConstants.MALE_60;
      }
    }
    else if(runName.equals("Midnight Run")) {
      if(age <= 18) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_18;
        else nameOfGroup = IWMarathonConstants.MALE_18;
      }
      else if(age > 18 && age <= 39) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_19_39;
        else nameOfGroup = IWMarathonConstants.MALE_19_39;
      }
      else if(age > 39 && age <= 49) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_40_49;
        else nameOfGroup = IWMarathonConstants.MALE_40_49;
        ...
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_50;
        else nameOfGroup = IWMarathonConstants.MALE_50;
      }
    }
    else if(runName.equals("Laugavegur")) {
      if(age > 17 && age <= 29) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_18_29;
        else nameOfGroup = IWMarathonConstants.MALE_18_29;
      }
      else if(age > 29 && age <= 39) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_30_39;
        else nameOfGroup = IWMarathonConstants.MALE_30_39;
      }
      else if(age > 39 && age <= 49) {
        if(genderID == 2) nameOfGroup = IWMarathonConstants.FEMALE_40_49;
        else nameOfGroup = IWMarathonConstants.MALE_40_49;
  ...
  public void createNewGroupYear(IWContext iwc, Group run, String year) {
    ...
    String[] grForMarathon = {IWMarathonConstants.FEMALE_14,
        IWMarathonConstants.FEMALE_15_17, IWMarathonConstants.FEMALE_18_39,
        IWMarathonConstants.FEMALE_40_49,IWMarathonConstants.FEMALE_50_59,
    ...
    String[] grForLaugavegur = {IWMarathonConstants.FEMALE_18_29,IWMarathonConstants.FEMALE_30_39,
        IWMarathonConstants.FEMALE_40_49,IWMarathonConstants.FEMALE_50,
        IWMarathonConstants.MALE_18_29,IWMarathonConstants.MALE_30_39,IWMarathonConstants.MALE_40_49,
    ...
    String[] grForMidnight = {IWMarathonConstants.FEMALE_18,IWMarathonConstants.FEMALE_19_39,
        IWMarathonConstants.FEMALE_40_49,IWMarathonConstants.FEMALE_50,
        IWMarathonConstants.MALE_18,IWMarathonConstants.MALE_19_39,
        IWMarathonConstants.MALE_40_49,IWMarathonConstants.MALE_50};
    //TODO: remove this hack - set metadata on the groups containing the specific run... 
  ...
  /**
   * gets all the run type groups of the type "iwma_run_marathon","iwma_run_laugavegur" and "iwma_run_midnight"
  ...
  /**
   * Gets all the years that exist for a specific run. The years are groups with the group type "iwma_year"
   * @param run - the supergroup of the years
  ...
  /**
   * Gets all the years that exist for a specific run. The years are groups with the group type "iwma_year".
   * This method returns a Map instead of a Collection. This is for example used to display the years in
   * a secondary dropdown menu when displaying two connected dropdowns. 
   * @param Group run - the supergroup of the years
  ...
  /**
   * Gets a Map of distances for a specific run and year. Distances are groups with the group type "iwma_distance".
   * @param Group run - the supersupergroup of the specific run
   * @param year - the year of the run
  ...
  /**
   * Gets all countries. This method is for example used when displaying a dropdown menu of all countries
