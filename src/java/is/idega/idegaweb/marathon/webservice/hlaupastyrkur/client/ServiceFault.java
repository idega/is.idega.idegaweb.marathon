...
public class ServiceFault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.marathon.webservice.hlaupastyrkur.client.ServiceException nestedException;
    ...
    public ServiceFault(
           ...
           is.idega.idegaweb.marathon.webservice.hlaupastyrkur.client.ServiceException nestedException) {
    ...
    /**
     * Gets the nestedException value for this ServiceFault.
     * 
     * @return nestedException
     */
    public is.idega.idegaweb.marathon.webservice.hlaupastyrkur.client.ServiceException getNestedException() {
        return nestedException;
    }


    /**
     * Sets the nestedException value for this ServiceFault.
     * 
     * @param nestedException
     */
    public void setNestedException(is.idega.idegaweb.marathon.webservice.hlaupastyrkur.client.ServiceException nestedException) {
        this.nestedException = nestedException;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tmsoftware.is/Service/Faults/", "ServiceFault"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://tmsoftware.is/Service/Faults/", "NestedException"));
